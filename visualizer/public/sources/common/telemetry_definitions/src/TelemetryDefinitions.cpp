...
static constexpr hdtn::Logger::SubProcess subprocess =
    hdtn::Logger::SubProcess::none;

// for non-throw versions of get_child which return a reference to the second
// parameter
...
StorageTelemetry_t::StorageTelemetry_t()
    : m_timestampMilliseconds(0),
      ...
      m_numRfc5050CustodyTransfers(0), m_numAcsCustodyTransfers(0),
      m_numAcsPacketsReceived(0),
      // from BundleStorageCatalog
      m_numBundlesOnDisk(0), m_numBundleBytesOnDisk(0),
      ...
      m_usedSpaceBytes(0), m_freeSpaceBytes(0) {}
StorageTelemetry_t::~StorageTelemetry_t() {}
bool StorageTelemetry_t::operator==(const StorageTelemetry_t &o) const {
  return (m_timestampMilliseconds == o.m_timestampMilliseconds) &&
         (m_totalBundlesErasedFromStorageNoCustodyTransfer ==
          o.m_totalBundlesErasedFromStorageNoCustodyTransfer) &&
         (m_totalBundlesErasedFromStorageWithCustodyTransfer ==
          o.m_totalBundlesErasedFromStorageWithCustodyTransfer) &&
         (m_totalBundlesErasedFromStorageBecauseExpired ==
          o.m_totalBundlesErasedFromStorageBecauseExpired) &&
         (m_totalBundlesRewrittenToStorageFromFailedEgressSend ==
          o.m_totalBundlesRewrittenToStorageFromFailedEgressSend) &&
         (m_totalBundlesSentToEgressFromStorageReadFromDisk ==
          o.m_totalBundlesSentToEgressFromStorageReadFromDisk) &&
         (m_totalBundleBytesSentToEgressFromStorageReadFromDisk ==
          o.m_totalBundleBytesSentToEgressFromStorageReadFromDisk) &&
         (m_totalBundlesSentToEgressFromStorageForwardCutThrough ==
          o.m_totalBundlesSentToEgressFromStorageForwardCutThrough) &&
         (m_totalBundleBytesSentToEgressFromStorageForwardCutThrough ==
          o.m_totalBundleBytesSentToEgressFromStorageForwardCutThrough) &&
         ...
         (m_totalBundleWriteOperationsToDisk ==
          o.m_totalBundleWriteOperationsToDisk) &&
         (m_totalBundleByteWriteOperationsToDisk ==
          o.m_totalBundleByteWriteOperationsToDisk) &&
         (m_totalBundleEraseOperationsFromDisk ==
          o.m_totalBundleEraseOperationsFromDisk) &&
         (m_totalBundleByteEraseOperationsFromDisk ==
          o.m_totalBundleByteEraseOperationsFromDisk) &&
...
bool StorageTelemetry_t::SetValuesFromPropertyTree(
    const boost::property_tree::ptree &pt) {
  try {
    m_timestampMilliseconds = pt.get<uint64_t>("timestampMilliseconds");
    m_totalBundlesErasedFromStorageNoCustodyTransfer =
        pt.get<uint64_t>("totalBundlesErasedFromStorageNoCustodyTransfer");
    m_totalBundlesErasedFromStorageWithCustodyTransfer =
        pt.get<uint64_t>("totalBundlesErasedFromStorageWithCustodyTransfer");
    m_totalBundlesErasedFromStorageBecauseExpired =
        pt.get<uint64_t>("totalBundlesErasedFromStorageBecauseExpired");
    m_totalBundlesRewrittenToStorageFromFailedEgressSend =
        pt.get<uint64_t>("totalBundlesRewrittenToStorageFromFailedEgressSend");
    m_totalBundlesSentToEgressFromStorageReadFromDisk =
        pt.get<uint64_t>("totalBundlesSentToEgressFromStorageReadFromDisk");
    m_totalBundleBytesSentToEgressFromStorageReadFromDisk =
        pt.get<uint64_t>("totalBundleBytesSentToEgressFromStorageReadFromDisk");
    m_totalBundlesSentToEgressFromStorageForwardCutThrough = pt.get<uint64_t>(
    ...
    m_numRfc5050CustodyTransfers =
        pt.get<uint64_t>("numRfc5050CustodyTransfers");
    ...
    m_totalBundleWriteOperationsToDisk =
        pt.get<uint64_t>("totalBundleWriteOperationsToDisk");
    m_totalBundleByteWriteOperationsToDisk =
        pt.get<uint64_t>("totalBundleByteWriteOperationsToDisk");
    m_totalBundleEraseOperationsFromDisk =
        pt.get<uint64_t>("totalBundleEraseOperationsFromDisk");
    m_totalBundleByteEraseOperationsFromDisk =
        pt.get<uint64_t>("totalBundleByteEraseOperationsFromDisk");
...
boost::property_tree::ptree StorageTelemetry_t::GetNewPropertyTree() const {
  ...
  pt.put("totalBundlesErasedFromStorageNoCustodyTransfer",
         m_totalBundlesErasedFromStorageNoCustodyTransfer);
  pt.put("totalBundlesErasedFromStorageWithCustodyTransfer",
         m_totalBundlesErasedFromStorageWithCustodyTransfer);
  pt.put("totalBundlesErasedFromStorageBecauseExpired",
         m_totalBundlesErasedFromStorageBecauseExpired);
  pt.put("totalBundlesRewrittenToStorageFromFailedEgressSend",
         m_totalBundlesRewrittenToStorageFromFailedEgressSend);
  pt.put("totalBundlesSentToEgressFromStorageReadFromDisk",
         m_totalBundlesSentToEgressFromStorageReadFromDisk);
  pt.put("totalBundleBytesSentToEgressFromStorageReadFromDisk",
         m_totalBundleBytesSentToEgressFromStorageReadFromDisk);
  pt.put("totalBundlesSentToEgressFromStorageForwardCutThrough",
         m_totalBundlesSentToEgressFromStorageForwardCutThrough);
  pt.put("totalBundleBytesSentToEgressFromStorageForwardCutThrough",
         m_totalBundleBytesSentToEgressFromStorageForwardCutThrough);
  ...
  pt.put("totalBundleWriteOperationsToDisk",
         m_totalBundleWriteOperationsToDisk);
  pt.put("totalBundleByteWriteOperationsToDisk",
         m_totalBundleByteWriteOperationsToDisk);
  pt.put("totalBundleEraseOperationsFromDisk",
         m_totalBundleEraseOperationsFromDisk);
  pt.put("totalBundleByteEraseOperationsFromDisk",
         m_totalBundleByteEraseOperationsFromDisk);
...
StorageExpiringBeforeThresholdTelemetry_t::
    ~StorageExpiringBeforeThresholdTelemetry_t() {}
bool StorageExpiringBeforeThresholdTelemetry_t::operator==(
    const StorageExpiringBeforeThresholdTelemetry_t &o) const {
  return (priority == o.priority) &&
         (thresholdSecondsSinceStartOfYear2000 ==
          o.thresholdSecondsSinceStartOfYear2000) &&
         (mapNodeIdToExpiringBeforeThresholdCount ==
          o.mapNodeIdToExpiringBeforeThresholdCount);
}
bool StorageExpiringBeforeThresholdTelemetry_t::operator!=(
    const StorageExpiringBeforeThresholdTelemetry_t &o) const {
  return !(*this == o);
...
bool StorageExpiringBeforeThresholdTelemetry_t::SetValuesFromPropertyTree(
    const boost::property_tree::ptree &pt) {
  try {
    priority = pt.get<uint64_t>("priority");
    thresholdSecondsSinceStartOfYear2000 =
        pt.get<uint64_t>("thresholdSecondsSinceStartOfYear2000");
    mapNodeIdToExpiringBeforeThresholdCount.clear();
    const boost::property_tree::ptree &nodeIdMapPt = pt.get_child(
        "nodesExpiringBeforeThresholdCount", EMPTY_PTREE); // non-throw version
    BOOST_FOREACH (const boost::property_tree::ptree::value_type &nodePt,
                   nodeIdMapPt) {
      const uint64_t nodeId = nodePt.second.get<uint64_t>("nodeId");
      bundle_count_plus_bundle_bytes_pair_t &p =
          mapNodeIdToExpiringBeforeThresholdCount[nodeId];
    ...
    LOG_ERROR(subprocess)
        << "parsing JSON StorageExpiringBeforeThresholdTelemetry_t: "
        << e.what();
  } catch (const boost::property_tree::ptree_error &e) {
    LOG_ERROR(subprocess)
        << "parsing JSON StorageExpiringBeforeThresholdTelemetry_t: "
...
StorageExpiringBeforeThresholdTelemetry_t::GetNewPropertyTree() const {
  boost::property_tree::ptree pt;
  pt.put("priority", priority);
  pt.put("thresholdSecondsSinceStartOfYear2000",
         thresholdSecondsSinceStartOfYear2000);
  boost::property_tree::ptree &nodeIdsExpiringBeforeThresholdCountPt =
      pt.put_child("nodesExpiringBeforeThresholdCount",
                   mapNodeIdToExpiringBeforeThresholdCount.empty()
                       ? boost::property_tree::ptree("[]")
                       : boost::property_tree::ptree());
  for (std::map<uint64_t, bundle_count_plus_bundle_bytes_pair_t>::const_iterator
           it = mapNodeIdToExpiringBeforeThresholdCount.cbegin();
       it != mapNodeIdToExpiringBeforeThresholdCount.cend(); ++it) {
    const std::pair<const uint64_t, bundle_count_plus_bundle_bytes_pair_t>
        &elPair = *it;
    boost::property_tree::ptree &node =
        (nodeIdsExpiringBeforeThresholdCountPt.push_back(
...
OutductCapabilityTelemetry_t::OutductCapabilityTelemetry_t()
    : outductArrayIndex(0), maxBundlesInPipeline(0),
      maxBundleSizeBytesInPipeline(0), nextHopNodeId(0),
      assumedInitiallyDown(false) {}
bool OutductCapabilityTelemetry_t::operator==(
    const OutductCapabilityTelemetry_t &o) const {
...
OutductCapabilityTelemetry_t::OutductCapabilityTelemetry_t(
    const OutductCapabilityTelemetry_t &o)
...
OutductCapabilityTelemetry_t::OutductCapabilityTelemetry_t(
    OutductCapabilityTelemetry_t &&o) noexcept
    : outductArrayIndex(o.outductArrayIndex),
      maxBundlesInPipeline(o.maxBundlesInPipeline),
      maxBundleSizeBytesInPipeline(o.maxBundleSizeBytesInPipeline),
      nextHopNodeId(o.nextHopNodeId),
...
OutductCapabilityTelemetry_t &OutductCapabilityTelemetry_t::operator=(
    const OutductCapabilityTelemetry_t
        &o) { // a copy assignment: operator=(const X&)
  outductArrayIndex = o.outductArrayIndex;
  maxBundlesInPipeline = o.maxBundlesInPipeline;
  maxBundleSizeBytesInPipeline = o.maxBundleSizeBytesInPipeline;
  nextHopNodeId = o.nextHopNodeId;
...
OutductCapabilityTelemetry_t &OutductCapabilityTelemetry_t::operator=(
    OutductCapabilityTelemetry_t
        &&o) noexcept { // a move assignment: operator=(X&&)
  outductArrayIndex = o.outductArrayIndex;
  maxBundlesInPipeline = o.maxBundlesInPipeline;
  maxBundleSizeBytesInPipeline = o.maxBundleSizeBytesInPipeline;
  nextHopNodeId = o.nextHopNodeId;
...
bool OutductCapabilityTelemetry_t::SetValuesFromPropertyTree(
    const boost::property_tree::ptree &pt) {
  try {
    outductArrayIndex = pt.get<uint64_t>("outductArrayIndex");
    maxBundlesInPipeline = pt.get<uint64_t>("maxBundlesInPipeline");
    maxBundleSizeBytesInPipeline =
        pt.get<uint64_t>("maxBundleSizeBytesInPipeline");
    nextHopNodeId = pt.get<uint64_t>("nextHopNodeId");
    assumedInitiallyDown = pt.get<bool>("assumedInitiallyDown");

    const boost::property_tree::ptree &finalDestinationEidsListPt =
        pt.get_child("finalDestinationEidsList",
                     EMPTY_PTREE); // non-throw version
    finalDestinationEidList.clear();
    finalDestinationNodeIdList.clear();
    BOOST_FOREACH (const boost::property_tree::ptree::value_type
                       &finalDestinationEidValuePt,
                   finalDestinationEidsListPt) {
      const std::string uriStr =
          finalDestinationEidValuePt.second.get_value<std::string>();
      uint64_t node, svc;
      bool serviceNumberIsWildCard;
      if (!Uri::ParseIpnUriString(uriStr, node, svc,
                                  &serviceNumberIsWildCard)) {
        LOG_ERROR(subprocess)
            << "error parsing JSON OutductCapabilityTelemetry_t: invalid final "
               "destination eid uri "
            << uriStr;
        return false;
      }
    ...
    LOG_ERROR(subprocess) << "parsing JSON OutductCapabilityTelemetry_t: "
                          << e.what();
    return false;
  }
  return true;
...
boost::property_tree::ptree
OutductCapabilityTelemetry_t::GetNewPropertyTree() const {
  boost::property_tree::ptree pt;
  ...
  boost::property_tree::ptree &eidListPt = pt.put_child(
      "finalDestinationEidsList",
      (finalDestinationEidList.empty() && finalDestinationNodeIdList.empty())
          ? boost::property_tree::ptree("[]")
          : boost::property_tree::ptree());
  for (std::list<cbhe_eid_t>::const_iterator it =
           finalDestinationEidList.cbegin();
       it != finalDestinationEidList.cend(); ++it) {
    const cbhe_eid_t &eid = *it;
    eidListPt.push_back(std::make_pair(
        "",
        boost::property_tree::ptree(Uri::GetIpnUriString(
            eid.nodeId, eid.serviceId)))); // using "" as key creates json array
  }
  for (std::list<uint64_t>::const_iterator it =
           finalDestinationNodeIdList.cbegin();
       it != finalDestinationNodeIdList.cend(); ++it) {
    const uint64_t nodeId = *it;
    eidListPt.push_back(std::make_pair(
        "", boost::property_tree::ptree(Uri::GetIpnUriStringAnyServiceNumber(
                nodeId)))); // using "" as key creates json array
  }
  return pt;
}
...
bool AllOutductCapabilitiesTelemetry_t::SetValuesFromPropertyTree(
    const boost::property_tree::ptree &pt) {
  try {
    const boost::property_tree::ptree &outductCapabilityTelemetryListPt =
        pt.get_child("outductCapabilityTelemetryList",
                     EMPTY_PTREE); // non-throw version
    outductCapabilityTelemetryList.clear();
    BOOST_FOREACH (const boost::property_tree::ptree::value_type
                       &outductCapabilityTelemetryValuePt,
                   outductCapabilityTelemetryListPt) {
      outductCapabilityTelemetryList.emplace_back();
      outductCapabilityTelemetryList.back().SetValuesFromPropertyTree(
          outductCapabilityTelemetryValuePt.second);
    }
  } catch (const boost::property_tree::ptree_error &e) {
    LOG_ERROR(subprocess) << "parsing JSON AllOutductCapabilitiesTelemetry_t: "
                          << e.what();
    return false;
  }
  return true;
...
boost::property_tree::ptree
AllOutductCapabilitiesTelemetry_t::GetNewPropertyTree() const {
  boost::property_tree::ptree pt;
  boost::property_tree::ptree &outductCapabilityTelemetryListPt = pt.put_child(
      "outductCapabilityTelemetryList", outductCapabilityTelemetryList.empty()
                                            ? boost::property_tree::ptree("[]")
                                            : boost::property_tree::ptree());
  for (std::list<OutductCapabilityTelemetry_t>::const_iterator it =
           outductCapabilityTelemetryList.cbegin();
       it != outductCapabilityTelemetryList.cend(); ++it) {
    const OutductCapabilityTelemetry_t &oct = *it;
    outductCapabilityTelemetryListPt.push_back(std::make_pair(
        "", oct.GetNewPropertyTree())); // using "" as key creates json array
  }
  return pt;
}
bool AllOutductCapabilitiesTelemetry_t::operator==(
    const AllOutductCapabilitiesTelemetry_t &o) const {
...
AllOutductCapabilitiesTelemetry_t::AllOutductCapabilitiesTelemetry_t(
    const AllOutductCapabilitiesTelemetry_t &o)
    : outductCapabilityTelemetryList(o.outductCapabilityTelemetryList) {
} // a copy constructor: X(const X&)
AllOutductCapabilitiesTelemetry_t::AllOutductCapabilitiesTelemetry_t(
    AllOutductCapabilitiesTelemetry_t &&o) noexcept
    : outductCapabilityTelemetryList(
          std::move(o.outductCapabilityTelemetryList)) {
} // a move constructor: X(X&&)
AllOutductCapabilitiesTelemetry_t &AllOutductCapabilitiesTelemetry_t::operator=(
    const AllOutductCapabilitiesTelemetry_t
        &o) { // a copy assignment: operator=(const X&)
  outductCapabilityTelemetryList = o.outductCapabilityTelemetryList;
  return *this;
}
...
InductConnectionTelemetry_t::InductConnectionTelemetry_t()
    : m_totalBundlesReceived(0), m_totalBundleBytesReceived(0) {}
InductConnectionTelemetry_t::~InductConnectionTelemetry_t() {}
bool InductConnectionTelemetry_t::operator==(
    const InductConnectionTelemetry_t &o) const {
...
bool InductConnectionTelemetry_t::SetValuesFromPropertyTree(
    const boost::property_tree::ptree &pt) {
  try {
    ...
    LOG_ERROR(subprocess) << "parsing JSON InductConnectionTelemetry_t: "
                          << e.what();
    return false;
  }
  return true;
...
boost::property_tree::ptree
InductConnectionTelemetry_t::GetNewPropertyTree() const {
  boost::property_tree::ptree pt;
...
StcpInductConnectionTelemetry_t::StcpInductConnectionTelemetry_t()
    : InductConnectionTelemetry_t(), m_totalStcpBytesReceived(0) {}
StcpInductConnectionTelemetry_t::~StcpInductConnectionTelemetry_t() {}
bool StcpInductConnectionTelemetry_t::operator==(
    const InductConnectionTelemetry_t &o) const {
  if (const StcpInductConnectionTelemetry_t *oPtr =
          dynamic_cast<const StcpInductConnectionTelemetry_t *>(&o)) {
...
bool StcpInductConnectionTelemetry_t::SetValuesFromPropertyTree(
    const boost::property_tree::ptree &pt) {
  ...
  try {
    ...
    LOG_ERROR(subprocess) << "parsing JSON StcpInductConnectionTelemetry_t: "
                          << e.what();
    return false;
  }
  return true;
...
boost::property_tree::ptree
StcpInductConnectionTelemetry_t::GetNewPropertyTree() const {
  boost::property_tree::ptree pt =
      InductConnectionTelemetry_t::GetNewPropertyTree();
  pt.put("totalStcpBytesReceived", m_totalStcpBytesReceived);
  return pt;
}

UdpInductConnectionTelemetry_t::UdpInductConnectionTelemetry_t()
    : InductConnectionTelemetry_t(), m_countCircularBufferOverruns(0) {}
UdpInductConnectionTelemetry_t::~UdpInductConnectionTelemetry_t() {}
bool UdpInductConnectionTelemetry_t::operator==(
    const InductConnectionTelemetry_t &o) const {
  if (const UdpInductConnectionTelemetry_t *oPtr =
          dynamic_cast<const UdpInductConnectionTelemetry_t *>(&o)) {
    return InductConnectionTelemetry_t::operator==(o) &&
           (m_countCircularBufferOverruns ==
            oPtr->m_countCircularBufferOverruns);
  }
  return false;
}
bool UdpInductConnectionTelemetry_t::operator!=(
...
bool UdpInductConnectionTelemetry_t::SetValuesFromPropertyTree(
    const boost::property_tree::ptree &pt) {
  if (!InductConnectionTelemetry_t::SetValuesFromPropertyTree(pt)) {
    return false;
  }
  try {
    m_countCircularBufferOverruns =
        pt.get<uint64_t>("countCircularBufferOverruns");
  } catch (const boost::property_tree::ptree_error &e) {
    LOG_ERROR(subprocess) << "parsing JSON UdpInductConnectionTelemetry_t: "
                          << e.what();
    return false;
  }
  return true;
...
boost::property_tree::ptree
UdpInductConnectionTelemetry_t::GetNewPropertyTree() const {
  boost::property_tree::ptree pt =
      InductConnectionTelemetry_t::GetNewPropertyTree();
...
TcpclV3InductConnectionTelemetry_t::TcpclV3InductConnectionTelemetry_t()
    : InductConnectionTelemetry_t(), m_totalIncomingFragmentsAcked(0),
      m_totalOutgoingFragmentsSent(0), m_totalBundlesSentAndAcked(0),
      m_totalBundleBytesSentAndAcked(0), m_totalBundlesSent(0),
      m_totalBundleBytesSent(0), m_totalBundlesFailedToSend(0) {}
TcpclV3InductConnectionTelemetry_t::~TcpclV3InductConnectionTelemetry_t() {}
bool TcpclV3InductConnectionTelemetry_t::operator==(
    const InductConnectionTelemetry_t &o) const {
  if (const TcpclV3InductConnectionTelemetry_t *oPtr =
          dynamic_cast<const TcpclV3InductConnectionTelemetry_t *>(&o)) {
    return InductConnectionTelemetry_t::operator==(o) &&
           (m_totalIncomingFragmentsAcked ==
            oPtr->m_totalIncomingFragmentsAcked) &&
           (m_totalOutgoingFragmentsSent ==
            oPtr->m_totalOutgoingFragmentsSent) &&
           (m_totalBundlesSentAndAcked == oPtr->m_totalBundlesSentAndAcked) &&
           (m_totalBundleBytesSentAndAcked ==
            oPtr->m_totalBundleBytesSentAndAcked) &&
...
bool TcpclV3InductConnectionTelemetry_t::SetValuesFromPropertyTree(
    const boost::property_tree::ptree &pt) {
  if (!InductConnectionTelemetry_t::SetValuesFromPropertyTree(pt)) {
    return false;
  }
  try {
    m_totalIncomingFragmentsAcked =
        pt.get<uint64_t>("totalIncomingFragmentsAcked");
    m_totalOutgoingFragmentsSent =
        pt.get<uint64_t>("totalOutgoingFragmentsSent");
    m_totalBundlesSentAndAcked = pt.get<uint64_t>("totalBundlesSentAndAcked");
    m_totalBundleBytesSentAndAcked =
        pt.get<uint64_t>("totalBundleBytesSentAndAcked");
    ...
    LOG_ERROR(subprocess) << "parsing JSON TcpclV3InductConnectionTelemetry_t: "
                          << e.what();
    return false;
  }
  return true;
...
boost::property_tree::ptree
TcpclV3InductConnectionTelemetry_t::GetNewPropertyTree() const {
  boost::property_tree::ptree pt =
      InductConnectionTelemetry_t::GetNewPropertyTree();
...
TcpclV4InductConnectionTelemetry_t::TcpclV4InductConnectionTelemetry_t()
    : InductConnectionTelemetry_t(), m_totalIncomingFragmentsAcked(0),
      ...
      m_totalBundleBytesSent(0), m_totalBundlesFailedToSend(0) {}
TcpclV4InductConnectionTelemetry_t::~TcpclV4InductConnectionTelemetry_t() {}
bool TcpclV4InductConnectionTelemetry_t::operator==(
    const InductConnectionTelemetry_t &o) const {
  if (const TcpclV4InductConnectionTelemetry_t *oPtr =
          dynamic_cast<const TcpclV4InductConnectionTelemetry_t *>(&o)) {
    return InductConnectionTelemetry_t::operator==(o) &&
           (m_totalIncomingFragmentsAcked ==
            oPtr->m_totalIncomingFragmentsAcked) &&
           (m_totalOutgoingFragmentsSent ==
...
bool TcpclV4InductConnectionTelemetry_t::SetValuesFromPropertyTree(
    const boost::property_tree::ptree &pt) {
  if (!InductConnectionTelemetry_t::SetValuesFromPropertyTree(pt)) {
    return false;
  }
  try {
    ...
    LOG_ERROR(subprocess) << "parsing JSON TcpclV4InductConnectionTelemetry_t: "
                          << e.what();
    return false;
  }
  return true;
...
boost::property_tree::ptree
TcpclV4InductConnectionTelemetry_t::GetNewPropertyTree() const {
  boost::property_tree::ptree pt =
      InductConnectionTelemetry_t::GetNewPropertyTree();
  pt.put("totalIncomingFragmentsAcked", m_totalIncomingFragmentsAcked);
  pt.put("totalOutgoingFragmentsSent", m_totalOutgoingFragmentsSent);
...
SlipOverUartInductConnectionTelemetry_t::
    SlipOverUartInductConnectionTelemetry_t()
    : InductConnectionTelemetry_t(), m_totalSlipBytesSent(0),
      m_totalSlipBytesReceived(0), m_totalReceivedChunks(0),
      m_largestReceivedBytesPerChunk(0), m_averageReceivedBytesPerChunk(0),
      m_totalBundlesSentAndAcked(0), m_totalBundleBytesSentAndAcked(0),
      m_totalBundlesSent(0), m_totalBundleBytesSent(0),
      m_totalBundlesFailedToSend(0) {}
SlipOverUartInductConnectionTelemetry_t::
    ~SlipOverUartInductConnectionTelemetry_t() {}
bool SlipOverUartInductConnectionTelemetry_t::operator==(
    const InductConnectionTelemetry_t &o) const {
  if (const SlipOverUartInductConnectionTelemetry_t *oPtr =
          dynamic_cast<const SlipOverUartInductConnectionTelemetry_t *>(&o)) {
    return InductConnectionTelemetry_t::operator==(o) &&
           ...
           (m_largestReceivedBytesPerChunk ==
            oPtr->m_largestReceivedBytesPerChunk) &&
           (m_averageReceivedBytesPerChunk ==
            oPtr->m_averageReceivedBytesPerChunk) &&
           (m_totalBundlesSentAndAcked == oPtr->m_totalBundlesSentAndAcked) &&
           (m_totalBundleBytesSentAndAcked ==
            oPtr->m_totalBundleBytesSentAndAcked) &&
           (m_totalBundlesSent == oPtr->m_totalBundlesSent) &&
...
bool SlipOverUartInductConnectionTelemetry_t::SetValuesFromPropertyTree(
    const boost::property_tree::ptree &pt) {
  if (!InductConnectionTelemetry_t::SetValuesFromPropertyTree(pt)) {
    return false;
  }
  try {
    ...
    m_largestReceivedBytesPerChunk =
        pt.get<uint64_t>("largestReceivedBytesPerChunk");
    m_averageReceivedBytesPerChunk =
        pt.get<uint64_t>("averageReceivedBytesPerChunk");
    m_totalBundlesSentAndAcked = pt.get<uint64_t>("totalBundlesSentAndAcked");
    m_totalBundleBytesSentAndAcked =
        pt.get<uint64_t>("totalBundleBytesSentAndAcked");
    m_totalBundlesSent = pt.get<uint64_t>("totalBundlesSent");
...
boost::property_tree::ptree
SlipOverUartInductConnectionTelemetry_t::GetNewPropertyTree() const {
  boost::property_tree::ptree pt =
      InductConnectionTelemetry_t::GetNewPropertyTree();
...
BpOverEncapLocalStreamInductConnectionTelemetry_t::
    BpOverEncapLocalStreamInductConnectionTelemetry_t()
    : InductConnectionTelemetry_t(), m_totalEncapHeaderBytesSent(0),
      m_totalEncapHeaderBytesReceived(0),
      m_largestEncapHeaderSizeBytesReceived(0),
      m_smallestEncapHeaderSizeBytesReceived(0),
      m_averageEncapHeaderSizeBytesReceived(0), m_totalBundlesSentAndAcked(0),
      m_totalBundleBytesSentAndAcked(0), m_totalBundlesSent(0),
      m_totalBundleBytesSent(0), m_totalBundlesFailedToSend(0) {}
BpOverEncapLocalStreamInductConnectionTelemetry_t::
    ~BpOverEncapLocalStreamInductConnectionTelemetry_t() {}
bool BpOverEncapLocalStreamInductConnectionTelemetry_t::operator==(
    const InductConnectionTelemetry_t &o) const {
  if (const BpOverEncapLocalStreamInductConnectionTelemetry_t *oPtr =
          dynamic_cast<
              const BpOverEncapLocalStreamInductConnectionTelemetry_t *>(&o)) {
    return InductConnectionTelemetry_t::operator==(o) &&
           (m_totalEncapHeaderBytesSent == oPtr->m_totalEncapHeaderBytesSent) &&
           (m_totalEncapHeaderBytesReceived ==
            oPtr->m_totalEncapHeaderBytesReceived) &&
           (m_largestEncapHeaderSizeBytesReceived ==
            oPtr->m_largestEncapHeaderSizeBytesReceived) &&
           (m_smallestEncapHeaderSizeBytesReceived ==
            oPtr->m_smallestEncapHeaderSizeBytesReceived) &&
           (m_averageEncapHeaderSizeBytesReceived ==
            oPtr->m_averageEncapHeaderSizeBytesReceived) &&
           (m_totalBundlesSentAndAcked == oPtr->m_totalBundlesSentAndAcked) &&
           (m_totalBundleBytesSentAndAcked ==
            oPtr->m_totalBundleBytesSentAndAcked) &&
           (m_totalBundlesSent == oPtr->m_totalBundlesSent) &&
...
bool BpOverEncapLocalStreamInductConnectionTelemetry_t::
    SetValuesFromPropertyTree(const boost::property_tree::ptree &pt) {
  if (!InductConnectionTelemetry_t::SetValuesFromPropertyTree(pt)) {
    return false;
  }
  try {
    ...
    m_totalEncapHeaderBytesReceived =
        pt.get<uint64_t>("totalEncapHeaderBytesReceived");
    m_largestEncapHeaderSizeBytesReceived =
        pt.get<uint64_t>("largestEncapHeaderSizeBytesReceived");
    m_smallestEncapHeaderSizeBytesReceived =
        pt.get<uint64_t>("smallestEncapHeaderSizeBytesReceived");
    m_averageEncapHeaderSizeBytesReceived =
        pt.get<uint64_t>("averageEncapHeaderSizeBytesReceived");
    m_totalBundlesSentAndAcked = pt.get<uint64_t>("totalBundlesSentAndAcked");
    m_totalBundleBytesSentAndAcked =
        pt.get<uint64_t>("totalBundleBytesSentAndAcked");
    m_totalBundlesSent = pt.get<uint64_t>("totalBundlesSent");
...
boost::property_tree::ptree
BpOverEncapLocalStreamInductConnectionTelemetry_t::GetNewPropertyTree() const {
  boost::property_tree::ptree pt =
      InductConnectionTelemetry_t::GetNewPropertyTree();
  ...
  pt.put("largestEncapHeaderSizeBytesReceived",
         m_largestEncapHeaderSizeBytesReceived);
  pt.put("smallestEncapHeaderSizeBytesReceived",
         m_smallestEncapHeaderSizeBytesReceived);
  pt.put("averageEncapHeaderSizeBytesReceived",
         m_averageEncapHeaderSizeBytesReceived);
  pt.put("totalBundlesSentAndAcked", m_totalBundlesSentAndAcked);
  pt.put("totalBundleBytesSentAndAcked", m_totalBundleBytesSentAndAcked);
  pt.put("totalBundlesSent", m_totalBundlesSent);
...
LtpInductConnectionTelemetry_t::LtpInductConnectionTelemetry_t()
    : InductConnectionTelemetry_t(), m_numReportSegmentTimerExpiredCallbacks(0),
      ...
      m_totalCancelSegmentsStarted(0), m_totalCancelSegmentSendRetries(0),
      m_totalCancelSegmentsFailedToSend(0),
      m_totalCancelSegmentsAcknowledged(0), m_numRxSessionsCancelledBySender(0),
      m_numStagnantRxSessionsDeleted(0), m_countUdpPacketsSent(0),
      m_countRxUdpCircularBufferOverruns(0),
      m_countTxUdpPacketsLimitedByRate(0) {}
LtpInductConnectionTelemetry_t::~LtpInductConnectionTelemetry_t() {}
bool LtpInductConnectionTelemetry_t::operator==(
    const InductConnectionTelemetry_t &o) const {
  if (const LtpInductConnectionTelemetry_t *oPtr =
          dynamic_cast<const LtpInductConnectionTelemetry_t *>(&o)) {
    return InductConnectionTelemetry_t::operator==(o) &&
           (m_numReportSegmentTimerExpiredCallbacks ==
            oPtr->m_numReportSegmentTimerExpiredCallbacks) &&
           (m_numReportSegmentsUnableToBeIssued ==
            oPtr->m_numReportSegmentsUnableToBeIssued) &&
           (m_numReportSegmentsTooLargeAndNeedingSplit ==
            oPtr->m_numReportSegmentsTooLargeAndNeedingSplit) &&
           (m_numReportSegmentsCreatedViaSplit ==
            oPtr->m_numReportSegmentsCreatedViaSplit) &&
           (m_numGapsFilledByOutOfOrderDataSegments ==
            oPtr->m_numGapsFilledByOutOfOrderDataSegments) &&
           (m_numDelayedFullyClaimedPrimaryReportSegmentsSent ==
            oPtr->m_numDelayedFullyClaimedPrimaryReportSegmentsSent) &&
           (m_numDelayedFullyClaimedSecondaryReportSegmentsSent ==
            oPtr->m_numDelayedFullyClaimedSecondaryReportSegmentsSent) &&
           (m_numDelayedPartiallyClaimedPrimaryReportSegmentsSent ==
            oPtr->m_numDelayedPartiallyClaimedPrimaryReportSegmentsSent) &&
           (m_numDelayedPartiallyClaimedSecondaryReportSegmentsSent ==
            oPtr->m_numDelayedPartiallyClaimedSecondaryReportSegmentsSent) &&
           (m_totalCancelSegmentsStarted ==
            oPtr->m_totalCancelSegmentsStarted) &&
           (m_totalCancelSegmentSendRetries ==
            oPtr->m_totalCancelSegmentSendRetries) &&
           (m_totalCancelSegmentsFailedToSend ==
            oPtr->m_totalCancelSegmentsFailedToSend) &&
           (m_totalCancelSegmentsAcknowledged ==
            oPtr->m_totalCancelSegmentsAcknowledged) &&
           (m_numRxSessionsCancelledBySender ==
            oPtr->m_numRxSessionsCancelledBySender) &&
           (m_numStagnantRxSessionsDeleted ==
            oPtr->m_numStagnantRxSessionsDeleted) &&
           (m_countUdpPacketsSent == oPtr->m_countUdpPacketsSent) &&
           (m_countRxUdpCircularBufferOverruns ==
            oPtr->m_countRxUdpCircularBufferOverruns) &&
           (m_countTxUdpPacketsLimitedByRate ==
            oPtr->m_countTxUdpPacketsLimitedByRate);
  }
  return false;
}
bool LtpInductConnectionTelemetry_t::operator!=(
...
bool LtpInductConnectionTelemetry_t::SetValuesFromPropertyTree(
    const boost::property_tree::ptree &pt) {
  if (!InductConnectionTelemetry_t::SetValuesFromPropertyTree(pt)) {
    return false;
  }
  try {
    m_numReportSegmentTimerExpiredCallbacks =
        pt.get<uint64_t>("numReportSegmentTimerExpiredCallbacks");
    m_numReportSegmentsUnableToBeIssued =
        pt.get<uint64_t>("numReportSegmentsUnableToBeIssued");
    m_numReportSegmentsTooLargeAndNeedingSplit =
        pt.get<uint64_t>("numReportSegmentsTooLargeAndNeedingSplit");
    m_numReportSegmentsCreatedViaSplit =
        pt.get<uint64_t>("numReportSegmentsCreatedViaSplit");
    m_numGapsFilledByOutOfOrderDataSegments =
        pt.get<uint64_t>("numGapsFilledByOutOfOrderDataSegments");
    m_numDelayedFullyClaimedPrimaryReportSegmentsSent =
        pt.get<uint64_t>("numDelayedFullyClaimedPrimaryReportSegmentsSent");
    m_numDelayedFullyClaimedSecondaryReportSegmentsSent =
        pt.get<uint64_t>("numDelayedFullyClaimedSecondaryReportSegmentsSent");
    m_numDelayedPartiallyClaimedPrimaryReportSegmentsSent =
        pt.get<uint64_t>("numDelayedPartiallyClaimedPrimaryReportSegmentsSent");
    m_numDelayedPartiallyClaimedSecondaryReportSegmentsSent = pt.get<uint64_t>(
        "numDelayedPartiallyClaimedSecondaryReportSegmentsSent");
    m_totalCancelSegmentsStarted =
        pt.get<uint64_t>("totalCancelSegmentsStarted");
    m_totalCancelSegmentSendRetries =
        pt.get<uint64_t>("totalCancelSegmentSendRetries");
    m_totalCancelSegmentsFailedToSend =
        pt.get<uint64_t>("totalCancelSegmentsFailedToSend");
    m_totalCancelSegmentsAcknowledged =
        pt.get<uint64_t>("totalCancelSegmentsAcknowledged");
    m_numRxSessionsCancelledBySender =
        pt.get<uint64_t>("numRxSessionsCancelledBySender");
    m_numStagnantRxSessionsDeleted =
        pt.get<uint64_t>("numStagnantRxSessionsDeleted");
    m_countUdpPacketsSent = pt.get<uint64_t>("countUdpPacketsSent");
    m_countRxUdpCircularBufferOverruns =
        pt.get<uint64_t>("countRxUdpCircularBufferOverruns");
    m_countTxUdpPacketsLimitedByRate =
        pt.get<uint64_t>("countTxUdpPacketsLimitedByRate");
  } catch (const boost::property_tree::ptree_error &e) {
    LOG_ERROR(subprocess) << "parsing JSON LtpInductConnectionTelemetry_t: "
                          << e.what();
    return false;
  }
  return true;
...
boost::property_tree::ptree
LtpInductConnectionTelemetry_t::GetNewPropertyTree() const {
  boost::property_tree::ptree pt =
      InductConnectionTelemetry_t::GetNewPropertyTree();
  pt.put("numReportSegmentTimerExpiredCallbacks",
         m_numReportSegmentTimerExpiredCallbacks);
  pt.put("numReportSegmentsUnableToBeIssued",
         m_numReportSegmentsUnableToBeIssued);
  pt.put("numReportSegmentsTooLargeAndNeedingSplit",
         m_numReportSegmentsTooLargeAndNeedingSplit);
  pt.put("numReportSegmentsCreatedViaSplit",
         m_numReportSegmentsCreatedViaSplit);
  pt.put("numGapsFilledByOutOfOrderDataSegments",
         m_numGapsFilledByOutOfOrderDataSegments);
  pt.put("numDelayedFullyClaimedPrimaryReportSegmentsSent",
         m_numDelayedFullyClaimedPrimaryReportSegmentsSent);
  pt.put("numDelayedFullyClaimedSecondaryReportSegmentsSent",
         m_numDelayedFullyClaimedSecondaryReportSegmentsSent);
  pt.put("numDelayedPartiallyClaimedPrimaryReportSegmentsSent",
         m_numDelayedPartiallyClaimedPrimaryReportSegmentsSent);
  pt.put("numDelayedPartiallyClaimedSecondaryReportSegmentsSent",
         m_numDelayedPartiallyClaimedSecondaryReportSegmentsSent);
  ...
  pt.put("countRxUdpCircularBufferOverruns",
         m_countRxUdpCircularBufferOverruns);
...
static bool UniquePtrInductConnectionTelemEquivalent(
    const std::unique_ptr<InductConnectionTelemetry_t> &a,
    const std::unique_ptr<InductConnectionTelemetry_t> &b) {
  if ((!a) && (!b))
...
bool InductTelemetry_t::operator==(const InductTelemetry_t &o) const {
  return std::equal(m_listInductConnections.begin(),
                    m_listInductConnections.end(),
                    o.m_listInductConnections.begin(),
                    UniquePtrInductConnectionTelemEquivalent);
  //(m_listInductConnections == o.m_listInductConnections);
}
bool InductTelemetry_t::operator!=(const InductTelemetry_t &o) const {
  return !(*this == o);
}
bool InductTelemetry_t::SetValuesFromPropertyTree(
    const boost::property_tree::ptree &pt) {
  try {
    m_convergenceLayer = pt.get<std::string>("convergenceLayer");
    const boost::property_tree::ptree &inductConnectionsPt =
        pt.get_child("inductConnections", EMPTY_PTREE); // non-throw version
    m_listInductConnections.clear();
    BOOST_FOREACH (
        const boost::property_tree::ptree::value_type &inductConnectionPt,
        inductConnectionsPt) {
      if ((m_convergenceLayer == "ltp_over_udp") ||
        ...
        m_listInductConnections.emplace_back(
            boost::make_unique<LtpInductConnectionTelemetry_t>());
        ...
        m_listInductConnections.emplace_back(
            boost::make_unique<SlipOverUartInductConnectionTelemetry_t>());
      } else if (m_convergenceLayer == "udp") {
        m_listInductConnections.emplace_back(
            boost::make_unique<UdpInductConnectionTelemetry_t>());
      } else if (m_convergenceLayer == "tcpcl_v3") {
        m_listInductConnections.emplace_back(
            boost::make_unique<TcpclV3InductConnectionTelemetry_t>());
      } else if (m_convergenceLayer == "tcpcl_v4") {
        m_listInductConnections.emplace_back(
            boost::make_unique<TcpclV4InductConnectionTelemetry_t>());
      } else if (m_convergenceLayer == "stcp") {
        m_listInductConnections.emplace_back(
            boost::make_unique<StcpInductConnectionTelemetry_t>());
      } else {
        return false;
      }
      if (!m_listInductConnections.back()->SetValuesFromPropertyTree(
              inductConnectionPt.second)) {
        return false;
      }
    }
  } catch (const boost::property_tree::ptree_error &e) {
...
boost::property_tree::ptree InductTelemetry_t::GetNewPropertyTree() const {
  ...
  boost::property_tree::ptree &inductConnectionsPt =
      pt.put_child("inductConnections", m_listInductConnections.empty()
                                            ? boost::property_tree::ptree("[]")
                                            : boost::property_tree::ptree());
  for (std::list<std::unique_ptr<InductConnectionTelemetry_t>>::const_iterator
           it = m_listInductConnections.cbegin();
       it != m_listInductConnections.cend(); ++it) {
    const std::unique_ptr<InductConnectionTelemetry_t> &ictPtr = *it;
    if (!ictPtr) {
      break;
    }
    inductConnectionsPt.push_back(std::make_pair(
        "",
        ictPtr->GetNewPropertyTree())); // using "" as key creates json array
  }
  return pt;
}

AllInductTelemetry_t::AllInductTelemetry_t()
    : m_timestampMilliseconds(0), m_bundleCountEgress(0),
      m_bundleCountStorage(0), m_bundleByteCountEgress(0),
...
bool AllInductTelemetry_t::SetValuesFromPropertyTree(
    const boost::property_tree::ptree &pt) {
  try {
    m_timestampMilliseconds = pt.get<uint64_t>("timestampMilliseconds");
    ...
    const boost::property_tree::ptree &allInductsPt =
        pt.get_child("allInducts", EMPTY_PTREE); // non-throw version
    m_listAllInducts.clear();
    BOOST_FOREACH (const boost::property_tree::ptree::value_type &inductPt,
                   allInductsPt) {
...
boost::property_tree::ptree AllInductTelemetry_t::GetNewPropertyTree() const {
  ...
  boost::property_tree::ptree &allInductsPt = pt.put_child(
      "allInducts", m_listAllInducts.empty() ? boost::property_tree::ptree("[]")
                                             : boost::property_tree::ptree());
  for (std::list<InductTelemetry_t>::const_iterator it =
           m_listAllInducts.cbegin();
       it != m_listAllInducts.cend(); ++it) {
    const InductTelemetry_t &induct = *it;
    allInductsPt.push_back(std::make_pair(
        "", induct.GetNewPropertyTree())); // using "" as key creates json array
  }
  return pt;
}
...
OutductTelemetry_t::OutductTelemetry_t()
    : m_totalBundlesAcked(0), m_totalBundleBytesAcked(0), m_totalBundlesSent(0),
      m_totalBundleBytesSent(0), m_totalBundlesFailedToSend(0),
      m_linkIsUpPhysically(false), m_linkIsUpPerTimeSchedule(false) {}
OutductTelemetry_t::~OutductTelemetry_t() {}
...
bool OutductTelemetry_t::SetValuesFromPropertyTree(
    const boost::property_tree::ptree &pt) {
  try {
    m_convergenceLayer = pt.get<std::string>("convergenceLayer");
...
StcpOutductTelemetry_t::StcpOutductTelemetry_t()
    : OutductTelemetry_t(), m_totalStcpBytesSent(0),
...
bool StcpOutductTelemetry_t::operator==(const OutductTelemetry_t &o) const {
  if (const StcpOutductTelemetry_t *oPtr =
          dynamic_cast<const StcpOutductTelemetry_t *>(&o)) {
...
bool StcpOutductTelemetry_t::SetValuesFromPropertyTree(
    const boost::property_tree::ptree &pt) {
  ...
  try {
    ...
    LOG_ERROR(subprocess) << "parsing JSON StcpOutductTelemetry_t: "
                          << e.what();
    return false;
  }
  return true;
...
LtpOutductTelemetry_t::LtpOutductTelemetry_t()
    : OutductTelemetry_t(), m_numCheckpointsExpired(0),
      m_numDiscretionaryCheckpointsNotResent(0),
      m_numDeletedFullyClaimedPendingReports(0),
      m_totalCancelSegmentsStarted(0), m_totalCancelSegmentSendRetries(0),
      m_totalCancelSegmentsFailedToSend(0),
      m_totalCancelSegmentsAcknowledged(0), m_totalPingsStarted(0),
      m_totalPingRetries(0), m_totalPingsFailedToSend(0),
      m_totalPingsAcknowledged(0), m_numTxSessionsReturnedToStorage(0),
      m_numTxSessionsCancelledByReceiver(0), m_countUdpPacketsSent(0),
      m_countRxUdpCircularBufferOverruns(0),
      m_countTxUdpPacketsLimitedByRate(0) {
...
bool LtpOutductTelemetry_t::operator==(const OutductTelemetry_t &o) const {
  if (const LtpOutductTelemetry_t *oPtr =
          dynamic_cast<const LtpOutductTelemetry_t *>(&o)) {
    return OutductTelemetry_t::operator==(o) &&
           (m_numCheckpointsExpired == oPtr->m_numCheckpointsExpired) &&
           (m_numDiscretionaryCheckpointsNotResent ==
            oPtr->m_numDiscretionaryCheckpointsNotResent) &&
           (m_numDeletedFullyClaimedPendingReports ==
            oPtr->m_numDeletedFullyClaimedPendingReports) &&
           (m_totalCancelSegmentsStarted ==
            oPtr->m_totalCancelSegmentsStarted) &&
           (m_totalCancelSegmentSendRetries ==
            oPtr->m_totalCancelSegmentSendRetries) &&
           ...
           (m_numTxSessionsReturnedToStorage ==
            oPtr->m_numTxSessionsReturnedToStorage) &&
           (m_numTxSessionsCancelledByReceiver ==
            oPtr->m_numTxSessionsCancelledByReceiver) &&
           (m_countUdpPacketsSent == oPtr->m_countUdpPacketsSent) &&
           (m_countRxUdpCircularBufferOverruns ==
            oPtr->m_countRxUdpCircularBufferOverruns) &&
           (m_countTxUdpPacketsLimitedByRate ==
...
bool LtpOutductTelemetry_t::SetValuesFromPropertyTree(
    const boost::property_tree::ptree &pt) {
  if (!OutductTelemetry_t::SetValuesFromPropertyTree(pt)) {
    return false;
  }
  try {
    ...
    m_numDiscretionaryCheckpointsNotResent =
        pt.get<uint64_t>("numDiscretionaryCheckpointsNotResent");
    m_numDeletedFullyClaimedPendingReports =
        pt.get<uint64_t>("numDeletedFullyClaimedPendingReports");
    m_totalCancelSegmentsStarted =
        pt.get<uint64_t>("totalCancelSegmentsStarted");
    m_totalCancelSegmentSendRetries =
        pt.get<uint64_t>("totalCancelSegmentSendRetries");
    ...
    m_numTxSessionsReturnedToStorage =
        pt.get<uint64_t>("numTxSessionsReturnedToStorage");
    m_numTxSessionsCancelledByReceiver =
        pt.get<uint64_t>("numTxSessionsCancelledByReceiver");
    m_countUdpPacketsSent = pt.get<uint64_t>("countUdpPacketsSent");
    m_countRxUdpCircularBufferOverruns =
        pt.get<uint64_t>("countRxUdpCircularBufferOverruns");
    m_countTxUdpPacketsLimitedByRate =
...
boost::property_tree::ptree LtpOutductTelemetry_t::GetNewPropertyTree() const {
  ...
  pt.put("numDiscretionaryCheckpointsNotResent",
         m_numDiscretionaryCheckpointsNotResent);
  pt.put("numDeletedFullyClaimedPendingReports",
         m_numDeletedFullyClaimedPendingReports);
  pt.put("totalCancelSegmentsStarted", m_totalCancelSegmentsStarted);
  pt.put("totalCancelSegmentSendRetries", m_totalCancelSegmentSendRetries);
  pt.put("totalCancelSegmentsFailedToSend", m_totalCancelSegmentsFailedToSend);
  ...
  pt.put("numTxSessionsCancelledByReceiver",
         m_numTxSessionsCancelledByReceiver);
  pt.put("countUdpPacketsSent", m_countUdpPacketsSent);
  pt.put("countRxUdpCircularBufferOverruns",
         m_countRxUdpCircularBufferOverruns);
...
TcpclV3OutductTelemetry_t::TcpclV3OutductTelemetry_t()
    : OutductTelemetry_t(), m_totalFragmentsAcked(0), m_totalFragmentsSent(0),
      m_totalBundlesReceived(0), m_totalBundleBytesReceived(0),
      m_numTcpReconnectAttempts(0) {
...
bool TcpclV3OutductTelemetry_t::operator==(const OutductTelemetry_t &o) const {
  if (const TcpclV3OutductTelemetry_t *oPtr =
          dynamic_cast<const TcpclV3OutductTelemetry_t *>(&o)) {
    return OutductTelemetry_t::operator==(o) &&
...
bool TcpclV3OutductTelemetry_t::SetValuesFromPropertyTree(
    const boost::property_tree::ptree &pt) {
  if (!OutductTelemetry_t::SetValuesFromPropertyTree(pt)) {
    return false;
  }
  try {
    ...
    LOG_ERROR(subprocess) << "parsing JSON TcpclV3OutductTelemetry_t: "
                          << e.what();
    return false;
  }
  return true;
...
boost::property_tree::ptree
TcpclV3OutductTelemetry_t::GetNewPropertyTree() const {
  boost::property_tree::ptree pt = OutductTelemetry_t::GetNewPropertyTree();
...
bool TcpclV4OutductTelemetry_t::operator==(const OutductTelemetry_t &o) const {
  if (const TcpclV4OutductTelemetry_t *oPtr =
          dynamic_cast<const TcpclV4OutductTelemetry_t *>(&o)) {
    return OutductTelemetry_t::operator==(o) &&
           (m_totalFragmentsAcked == oPtr->m_totalFragmentsAcked) &&
           (m_totalFragmentsSent == oPtr->m_totalFragmentsSent) &&
           (m_totalBundlesReceived == oPtr->m_totalBundlesReceived) &&
...
bool TcpclV4OutductTelemetry_t::SetValuesFromPropertyTree(
    const boost::property_tree::ptree &pt) {
  if (!OutductTelemetry_t::SetValuesFromPropertyTree(pt)) {
    return false;
  }
  try {
    ...
    LOG_ERROR(subprocess) << "parsing JSON TcpclV4OutductTelemetry_t: "
                          << e.what();
    return false;
  }
  return true;
...
boost::property_tree::ptree
TcpclV4OutductTelemetry_t::GetNewPropertyTree() const {
  boost::property_tree::ptree pt = OutductTelemetry_t::GetNewPropertyTree();
  pt.put("totalFragmentsAcked", m_totalFragmentsAcked);
  pt.put("totalFragmentsSent", m_totalFragmentsSent);
  pt.put("totalBundlesReceived", m_totalBundlesReceived);
...
SlipOverUartOutductTelemetry_t::SlipOverUartOutductTelemetry_t()
    : OutductTelemetry_t(), m_totalSlipBytesSent(0),
      m_totalSlipBytesReceived(0), m_totalReceivedChunks(0),
      m_largestReceivedBytesPerChunk(0), m_averageReceivedBytesPerChunk(0),
      m_totalBundlesReceived(0), m_totalBundleBytesReceived(0) {
...
SlipOverUartOutductTelemetry_t::~SlipOverUartOutductTelemetry_t() {}
bool SlipOverUartOutductTelemetry_t::operator==(
    const OutductTelemetry_t &o) const {
  if (const SlipOverUartOutductTelemetry_t *oPtr =
          dynamic_cast<const SlipOverUartOutductTelemetry_t *>(&o)) {
    return OutductTelemetry_t::operator==(o) &&
           (m_totalSlipBytesSent == oPtr->m_totalSlipBytesSent) &&
           (m_totalSlipBytesReceived == oPtr->m_totalSlipBytesReceived) &&
           (m_totalReceivedChunks == oPtr->m_totalReceivedChunks) &&
...
bool SlipOverUartOutductTelemetry_t::SetValuesFromPropertyTree(
    const boost::property_tree::ptree &pt) {
  if (!OutductTelemetry_t::SetValuesFromPropertyTree(pt)) {
    return false;
  }
...
boost::property_tree::ptree
SlipOverUartOutductTelemetry_t::GetNewPropertyTree() const {
  boost::property_tree::ptree pt = OutductTelemetry_t::GetNewPropertyTree();
  pt.put("totalSlipBytesSent", m_totalSlipBytesSent);
  pt.put("totalSlipBytesReceived", m_totalSlipBytesReceived);
  pt.put("totalReceivedChunks", m_totalReceivedChunks);
...
BpOverEncapLocalStreamOutductTelemetry_t::
    BpOverEncapLocalStreamOutductTelemetry_t()
    : OutductTelemetry_t(), m_totalEncapHeaderBytesSent(0),
      m_totalEncapHeaderBytesReceived(0), m_largestEncapHeaderSizeBytesSent(0),
      m_smallestEncapHeaderSizeBytesSent(0),
      m_averageEncapHeaderSizeBytesSent(0), m_totalBundlesReceived(0),
      m_totalBundleBytesReceived(0) {
  m_convergenceLayer = "bp_over_encap_local_stream";
}
BpOverEncapLocalStreamOutductTelemetry_t::
    ~BpOverEncapLocalStreamOutductTelemetry_t() {}
bool BpOverEncapLocalStreamOutductTelemetry_t::operator==(
    const OutductTelemetry_t &o) const {
  if (const BpOverEncapLocalStreamOutductTelemetry_t *oPtr =
          dynamic_cast<const BpOverEncapLocalStreamOutductTelemetry_t *>(&o)) {
    return OutductTelemetry_t::operator==(o) &&
           (m_totalEncapHeaderBytesSent == oPtr->m_totalEncapHeaderBytesSent) &&
           (m_totalEncapHeaderBytesReceived ==
            oPtr->m_totalEncapHeaderBytesReceived) &&
           (m_largestEncapHeaderSizeBytesSent ==
            oPtr->m_largestEncapHeaderSizeBytesSent) &&
           (m_smallestEncapHeaderSizeBytesSent ==
            oPtr->m_smallestEncapHeaderSizeBytesSent) &&
           (m_averageEncapHeaderSizeBytesSent ==
            oPtr->m_averageEncapHeaderSizeBytesSent) &&
           (m_totalBundlesReceived == oPtr->m_totalBundlesReceived) &&
           (m_totalBundleBytesReceived == oPtr->m_totalBundleBytesReceived);
  }
  return false;
...
bool BpOverEncapLocalStreamOutductTelemetry_t::SetValuesFromPropertyTree(
    const boost::property_tree::ptree &pt) {
  if (!OutductTelemetry_t::SetValuesFromPropertyTree(pt)) {
    return false;
  }
  try {
    ...
    m_totalEncapHeaderBytesReceived =
        pt.get<uint64_t>("totalEncapHeaderBytesReceived");
    m_largestEncapHeaderSizeBytesSent =
        pt.get<uint64_t>("largestEncapHeaderSizeBytesSent");
    m_smallestEncapHeaderSizeBytesSent =
        pt.get<uint64_t>("smallestEncapHeaderSizeBytesSent");
    m_averageEncapHeaderSizeBytesSent =
        pt.get<uint64_t>("averageEncapHeaderSizeBytesSent");
    m_totalBundlesReceived = pt.get<uint64_t>("totalBundlesReceived");
    m_totalBundleBytesReceived = pt.get<uint64_t>("totalBundleBytesReceived");
  } catch (const boost::property_tree::ptree_error &e) {
    LOG_ERROR(subprocess) << "parsing JSON TcpclV4OutductTelemetry_t: "
...
boost::property_tree::ptree
BpOverEncapLocalStreamOutductTelemetry_t::GetNewPropertyTree() const {
  boost::property_tree::ptree pt = OutductTelemetry_t::GetNewPropertyTree();
  pt.put("totalEncapHeaderBytesSent", m_totalEncapHeaderBytesSent);
  pt.put("totalEncapHeaderBytesReceived", m_totalEncapHeaderBytesReceived);
  pt.put("largestEncapHeaderSizeBytesSent", m_largestEncapHeaderSizeBytesSent);
  pt.put("smallestEncapHeaderSizeBytesSent",
         m_smallestEncapHeaderSizeBytesSent);
...
UdpOutductTelemetry_t::UdpOutductTelemetry_t()
    : OutductTelemetry_t(), m_totalPacketsSent(0), m_totalPacketBytesSent(0),
      m_totalPacketsDequeuedForSend(0), m_totalPacketBytesDequeuedForSend(0),
      m_totalPacketsLimitedByRate(0) {
  m_convergenceLayer = "udp";
}
UdpOutductTelemetry_t::~UdpOutductTelemetry_t() {}
bool UdpOutductTelemetry_t::operator==(const OutductTelemetry_t &o) const {
  if (const UdpOutductTelemetry_t *oPtr =
          dynamic_cast<const UdpOutductTelemetry_t *>(&o)) {
    return OutductTelemetry_t::operator==(o) &&
           ...
           (m_totalPacketsDequeuedForSend ==
            oPtr->m_totalPacketsDequeuedForSend) &&
           (m_totalPacketBytesDequeuedForSend ==
            oPtr->m_totalPacketBytesDequeuedForSend) &&
...
bool UdpOutductTelemetry_t::SetValuesFromPropertyTree(
    const boost::property_tree::ptree &pt) {
  if (!OutductTelemetry_t::SetValuesFromPropertyTree(pt)) {
    return false;
  }
  try {
    ...
    m_totalPacketsDequeuedForSend =
        pt.get<uint64_t>("totalPacketsDequeuedForSend");
    m_totalPacketBytesDequeuedForSend =
        pt.get<uint64_t>("totalPacketBytesDequeuedForSend");
...
AllOutductTelemetry_t::AllOutductTelemetry_t()
    : m_timestampMilliseconds(0), m_totalBundlesGivenToOutducts(0),
      m_totalBundleBytesGivenToOutducts(0), m_totalTcpclBundlesReceived(0),
      ...
      m_totalBundlesSuccessfullySent(0), m_totalBundleBytesSuccessfullySent(0) {
}
static bool
UniquePtrOutductTelemEquivalent(const std::unique_ptr<OutductTelemetry_t> &a,
                                const std::unique_ptr<OutductTelemetry_t> &b) {
  if ((!a) && (!b))
    return true; // both null
  if (!a)
    return false;
...
bool AllOutductTelemetry_t::operator==(const AllOutductTelemetry_t &o) const {
  return (m_timestampMilliseconds == o.m_timestampMilliseconds) &&
         ...
         (m_totalBundleBytesGivenToOutducts ==
          o.m_totalBundleBytesGivenToOutducts) &&
         (m_totalTcpclBundlesReceived == o.m_totalTcpclBundlesReceived) &&
         (m_totalTcpclBundleBytesReceived ==
          o.m_totalTcpclBundleBytesReceived) &&
         (m_totalStorageToIngressOpportunisticBundles ==
          o.m_totalStorageToIngressOpportunisticBundles) &&
         (m_totalStorageToIngressOpportunisticBundleBytes ==
          o.m_totalStorageToIngressOpportunisticBundleBytes) &&
         (m_totalBundlesSuccessfullySent == o.m_totalBundlesSuccessfullySent) &&
         (m_totalBundleBytesSuccessfullySent ==
          o.m_totalBundleBytesSuccessfullySent) &&
         std::equal(m_listAllOutducts.begin(), m_listAllOutducts.end(),
                    o.m_listAllOutducts.begin(),
                    UniquePtrOutductTelemEquivalent);
}
bool AllOutductTelemetry_t::operator!=(const AllOutductTelemetry_t &o) const {
  return !(*this == o);
}
bool AllOutductTelemetry_t::SetValuesFromPropertyTree(
    const boost::property_tree::ptree &pt) {
  try {
    m_timestampMilliseconds = pt.get<uint64_t>("timestampMilliseconds");
    m_totalBundlesGivenToOutducts =
        pt.get<uint64_t>("totalBundlesGivenToOutducts");
    m_totalBundleBytesGivenToOutducts =
        pt.get<uint64_t>("totalBundleBytesGivenToOutducts");
    m_totalTcpclBundlesReceived = pt.get<uint64_t>("totalTcpclBundlesReceived");
    m_totalTcpclBundleBytesReceived =
        pt.get<uint64_t>("totalTcpclBundleBytesReceived");
    m_totalStorageToIngressOpportunisticBundles =
        pt.get<uint64_t>("totalStorageToIngressOpportunisticBundles");
    m_totalStorageToIngressOpportunisticBundleBytes =
        pt.get<uint64_t>("totalStorageToIngressOpportunisticBundleBytes");
    m_totalBundlesSuccessfullySent =
        pt.get<uint64_t>("totalBundlesSuccessfullySent");
    m_totalBundleBytesSuccessfullySent =
        pt.get<uint64_t>("totalBundleBytesSuccessfullySent");
    const boost::property_tree::ptree &allOutductsPt =
        pt.get_child("allOutducts", EMPTY_PTREE); // non-throw version
    m_listAllOutducts.clear();
    BOOST_FOREACH (const boost::property_tree::ptree::value_type &outductPt,
                   allOutductsPt) {
      const std::string convergenceLayer =
          outductPt.second.get<std::string>("convergenceLayer");

      if ((convergenceLayer == "ltp_over_udp") ||
          (convergenceLayer == "ltp_over_ipc") ||
          (convergenceLayer == "ltp_over_encap_local_stream")) {
        m_listAllOutducts.emplace_back(
            boost::make_unique<LtpOutductTelemetry_t>());
      } else if (convergenceLayer == "bp_over_encap_local_stream") {
        m_listAllOutducts.emplace_back(
            boost::make_unique<BpOverEncapLocalStreamOutductTelemetry_t>());
      } else if (convergenceLayer == "slip_over_uart") {
        m_listAllOutducts.emplace_back(
            boost::make_unique<SlipOverUartOutductTelemetry_t>());
      } else if (convergenceLayer == "udp") {
        m_listAllOutducts.emplace_back(
            boost::make_unique<UdpOutductTelemetry_t>());
      } else if (convergenceLayer == "tcpcl_v3") {
        m_listAllOutducts.emplace_back(
            boost::make_unique<TcpclV3OutductTelemetry_t>());
      } else if (convergenceLayer == "tcpcl_v4") {
        m_listAllOutducts.emplace_back(
            boost::make_unique<TcpclV4OutductTelemetry_t>());
      } else if (convergenceLayer == "stcp") {
        m_listAllOutducts.emplace_back(
            boost::make_unique<StcpOutductTelemetry_t>());
      } else {
        return false;
      }
      if (!m_listAllOutducts.back()->SetValuesFromPropertyTree(
              outductPt.second)) {
        return false;
      }
    }
...
boost::property_tree::ptree AllOutductTelemetry_t::GetNewPropertyTree() const {
  ...
  pt.put("totalStorageToIngressOpportunisticBundles",
         m_totalStorageToIngressOpportunisticBundles);
  pt.put("totalStorageToIngressOpportunisticBundleBytes",
         m_totalStorageToIngressOpportunisticBundleBytes);
  pt.put("totalBundlesSuccessfullySent", m_totalBundlesSuccessfullySent);
  pt.put("totalBundleBytesSuccessfullySent",
         m_totalBundleBytesSuccessfullySent);
  boost::property_tree::ptree &allInductsPt =
      pt.put_child("allOutducts", m_listAllOutducts.empty()
                                      ? boost::property_tree::ptree("[]")
                                      : boost::property_tree::ptree());
  for (std::list<std::unique_ptr<OutductTelemetry_t>>::const_iterator it =
           m_listAllOutducts.cbegin();
       it != m_listAllOutducts.cend(); ++it) {
    ...
    allInductsPt.push_back(std::make_pair(
        "", outductPtr
                ->GetNewPropertyTree())); // using "" as key creates json array
  }
  return pt;
}
...
const std::string GenerateBundleApiCommand_t::name = "generate_bundle";
...
bool ApiCommand_t::SetValuesFromPropertyTree(
    const boost::property_tree::ptree &pt) {
  try {
...
std::shared_ptr<ApiCommand_t>
ApiCommand_t::CreateFromJson(const std::string &jsonStr) {
  ...
  } else if (apiCall == GenerateBundleApiCommand_t::name) {
    apiCommandPtr = std::make_shared<GenerateBundleApiCommand_t>();
...
bool PingApiCommand_t::SetValuesFromPropertyTree(
    const boost::property_tree::ptree &pt) {
...
bool PingApiCommand_t::operator==(const ApiCommand_t &o) const {
  if (const PingApiCommand_t *oPtr =
          dynamic_cast<const PingApiCommand_t *>(&o)) {
    return ApiCommand_t::operator==(o) && (m_nodeId == oPtr->m_nodeId) &&
...
bool UploadContactPlanApiCommand_t::SetValuesFromPropertyTree(
    const boost::property_tree::ptree &pt) {
  if (!ApiCommand_t::SetValuesFromPropertyTree(pt)) {
    return false;
  }
  try {
    ...
    LOG_ERROR(subprocess) << "parsing JSON UploadContactPlanApiCommand_t: "
                          << e.what();
    return false;
  } catch (const boost::property_tree::ptree_error &e) {
    LOG_ERROR(subprocess) << "parsing JSON UploadContactPlanApiCommand_t: "
...
boost::property_tree::ptree
UploadContactPlanApiCommand_t::GetNewPropertyTree() const {
  boost::property_tree::ptree pt = ApiCommand_t::GetNewPropertyTree();
...
bool UploadContactPlanApiCommand_t::operator==(const ApiCommand_t &o) const {
  if (const UploadContactPlanApiCommand_t *oPtr =
          dynamic_cast<const UploadContactPlanApiCommand_t *>(&o)) {
...
bool GetExpiringStorageApiCommand_t::SetValuesFromPropertyTree(
    const boost::property_tree::ptree &pt) {
  if (!ApiCommand_t::SetValuesFromPropertyTree(pt)) {
    return false;
  }
  try {
    ...
    LOG_ERROR(subprocess) << "parsing JSON GetExpiringStorageApiCommand_t: "
                          << e.what();
    return false;
  } catch (const boost::property_tree::ptree_error &e) {
    LOG_ERROR(subprocess) << "parsing JSON GetExpiringStorageApiCommand_t: "
...
boost::property_tree::ptree
GetExpiringStorageApiCommand_t::GetNewPropertyTree() const {
  boost::property_tree::ptree pt = ApiCommand_t::GetNewPropertyTree();
...
bool GetExpiringStorageApiCommand_t::operator==(const ApiCommand_t &o) const {
  if (const GetExpiringStorageApiCommand_t *oPtr =
          dynamic_cast<const GetExpiringStorageApiCommand_t *>(&o)) {
    return ApiCommand_t::operator==(o) && (m_priority == oPtr->m_priority) &&
...
bool UpdateBpSecApiCommand_t::SetValuesFromPropertyTree(
    const boost::property_tree::ptree &pt) {
  if (!ApiCommand_t::SetValuesFromPropertyTree(pt)) {
    return false;
  }
  try {
    ...
    LOG_ERROR(subprocess) << "parsing JSON UpdateBpSecApiCommand_t: "
                          << e.what();
    return false;
  } catch (const boost::property_tree::ptree_error &e) {
    LOG_ERROR(subprocess) << "parsing JSON UpdateBpSecApiCommand_t: "
...
boost::property_tree::ptree
UpdateBpSecApiCommand_t::GetNewPropertyTree() const {
  boost::property_tree::ptree pt = ApiCommand_t::GetNewPropertyTree();
...
bool UpdateBpSecApiCommand_t::operator==(const ApiCommand_t &o) const {
  if (const UpdateBpSecApiCommand_t *oPtr =
          dynamic_cast<const UpdateBpSecApiCommand_t *>(&o)) {
    return ApiCommand_t::operator==(o) && (m_bpSecJson == oPtr->m_bpSecJson);
  }
  return false;
}
...
GetBpSecApiCommand_t::GetBpSecApiCommand_t() : ApiCommand_t() {
...
bool SetMaxSendRateApiCommand_t::SetValuesFromPropertyTree(
    const boost::property_tree::ptree &pt) {
  if (!ApiCommand_t::SetValuesFromPropertyTree(pt)) {
    return false;
  }
  try {
    ...
    LOG_ERROR(subprocess) << "parsing JSON SetMaxSendRateApiCommand_t: "
                          << e.what();
    return false;
  } catch (const boost::property_tree::ptree_error &e) {
    LOG_ERROR(subprocess) << "parsing JSON SetMaxSendRateApiCommand_t: "
...
boost::property_tree::ptree
SetMaxSendRateApiCommand_t::GetNewPropertyTree() const {
  boost::property_tree::ptree pt = ApiCommand_t::GetNewPropertyTree();
...
bool SetMaxSendRateApiCommand_t::operator==(const ApiCommand_t &o) const {
  if (const SetMaxSendRateApiCommand_t *oPtr =
          dynamic_cast<const SetMaxSendRateApiCommand_t *>(&o)) {
    return ApiCommand_t::operator==(o) &&
...
bool SetLinkDownApiCommand_t::SetValuesFromPropertyTree(
    const boost::property_tree::ptree &pt) {
  if (!ApiCommand_t::SetValuesFromPropertyTree(pt)) {
    return false;
  }
  try {
    ...
    LOG_ERROR(subprocess) << "parsing JSON SetLinkDownApiCommand_t: "
                          << e.what();
    return false;
  } catch (const boost::property_tree::ptree_error &e) {
    LOG_ERROR(subprocess) << "parsing JSON SetLinkDownApiCommand_t: "
...
boost::property_tree::ptree
SetLinkDownApiCommand_t::GetNewPropertyTree() const {
  boost::property_tree::ptree pt = ApiCommand_t::GetNewPropertyTree();
...
bool SetLinkDownApiCommand_t::operator==(const ApiCommand_t &o) const {
  if (const SetLinkDownApiCommand_t *oPtr =
          dynamic_cast<const SetLinkDownApiCommand_t *>(&o)) {
    return ApiCommand_t::operator==(o) && (m_index == oPtr->m_index);
  }
  return true;
}
...
SetLinkUpApiCommand_t::SetLinkUpApiCommand_t() : ApiCommand_t(), m_index(0) {
  ApiCommand_t::m_apiCall = SetLinkDownApiCommand_t::name;
}

bool SetLinkUpApiCommand_t::SetValuesFromPropertyTree(
    const boost::property_tree::ptree &pt) {
  if (!ApiCommand_t::SetValuesFromPropertyTree(pt)) {
    return false;
  }
...
bool SetLinkUpApiCommand_t::operator==(const ApiCommand_t &o) const {
  if (const SetLinkUpApiCommand_t *oPtr =
          dynamic_cast<const SetLinkUpApiCommand_t *>(&o)) {
    return ApiCommand_t::operator==(o) && (m_index == oPtr->m_index);
  }
  return true;
}
...
/**
 * GenerateBundleApiCommand_t
 */
GenerateBundleApiCommand_t::GenerateBundleApiCommand_t()
    : ApiCommand_t(), m_destNodeId(0), m_message("") {
  ApiCommand_t::m_apiCall = GenerateBundleApiCommand_t::name;
}
GenerateBundleApiCommand_t::~GenerateBundleApiCommand_t() {}

bool GenerateBundleApiCommand_t::SetValuesFromPropertyTree(
    const boost::property_tree::ptree &pt) {
  if (!ApiCommand_t::SetValuesFromPropertyTree(pt)) {
    return false;
  }
  try {
    m_destNodeId = pt.get<uint64_t>("destNodeId");
    m_message = pt.get<std::string>("message");
  } catch (const boost::bad_lexical_cast &e) {
    LOG_ERROR(subprocess) << "parsing JSON GenerateBundleApiCommand_t: "
                          << e.what();
    return false;
  } catch (const boost::property_tree::ptree_error &e) {
    LOG_ERROR(subprocess) << "parsing JSON GenerateBundleApiCommand_t: "
...
boost::property_tree::ptree
GenerateBundleApiCommand_t::GetNewPropertyTree() const {
  boost::property_tree::ptree pt = ApiCommand_t::GetNewPropertyTree();
  pt.put("destNodeId", m_destNodeId);
  pt.put("message", m_message);
  return pt;
}

bool GenerateBundleApiCommand_t::operator==(const ApiCommand_t &o) const {
  if (const GenerateBundleApiCommand_t *oPtr =
          dynamic_cast<const GenerateBundleApiCommand_t *>(&o)) {
    return ApiCommand_t::operator==(o) &&
           (m_destNodeId == oPtr->m_destNodeId) &&
           (m_message == oPtr->m_message);
  }
  return false;
}
...
bool ApiResp_t::SetValuesFromPropertyTree(
    const boost::property_tree::ptree &pt) {
  try {
